    ...
    return (
        <div className='flex flex-col w-8/12 mx-auto mt-[75px] relative py-3'>
            ...
            <div className='mt-4  bg-green-800 flex p-[50px] py-[60px] gap-[50px] rounded-[30px]'>
                <div className='bg-green-400  w-[283px] flex flex-col justify-between relative rounded-md'>
                    <img src="Rectangle6.png" className='mx-auto my-9' width={200} height={800} alt="" />
                    <div>
                        ...
                        <div className='relative left-[180px]'>
                            ...
                            <img src="Polygon1.png" className='z-10 absolute top-[16px] left-[21px] ' alt="polygon" />
                        </div>
                    </div>
                </div>
                <div className='bg-green-400 w-[283px] relative rounded-md'>
                    <img src="Ellipse2.svg" className='mx-auto my-6' width={200} height={112} alt="" />
                    <p className='mt-3  px-3 heading-600 font-inter text-lg font-bold'>Classify Waste in Reduce,Reuse and Recyclable</p>
                    <div className='relative left-[180px]'>
                        <img src="Ellipse1.svg" alt="eclipse" />
                        <img src="Polygon1.png" className='z-10 absolute top-[16px] left-[21px] ' alt="" />
                    </div>
                </div>
                <div className='bg-green-400 w-[283px] relative rounded-md '>
                    <img src="Ellipse3.svg" className='mx-auto my-6' width={200} height={112} alt="" />
